...
namespace BonaForMe.UI.Controllers
{
    ...
    public class OrderHourController : Controller
    {
        ...
        [AllowAnonymous]
        [HttpPost]
        public IActionResult Save(OrderHourDto orderHourDto)
        {
            try
            {
        ...
        [AllowAnonymous]
        [HttpPost]
        public IActionResult Update(OrderHourDto orderHourDto)
        {
            try
            {
        ...
        [HttpPost]
        public JsonResult GetAllOrderHour()
        {
            try
            {
        ...
        public IActionResult LoadOrderHourData()
        {
            try
            {
                ...
                return _orderHourService.FillDataTable(dataTable);
            }
            catch (Exception)
            {
                return null;
